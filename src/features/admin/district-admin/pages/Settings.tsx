    ...
    const fetchAdminData = async () => {
        try {
            ...
            if (statsResponse.ok) {
                ...
                console.log('📊 Settings stats:', statsData);
                setStats({
                    totalMembers: statsData.data.total,
                    pendingApprovals: statsData.data.pending,
                    approved: statsData.data.approved,
                    rejected: statsData.data.rejected
                });
            }
        } catch (error) {
