    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="md:hidden flex items-center justify-between p-4 bg-white border-b">
          ...
          <Avatar className="w-10 h-10 cursor-pointer hover:ring-2 hover:ring-blue-400 transition-all" onClick={() => navigate('/member/profile-view')}>
          ...
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4 mt-4">
                <Avatar className="w-16 h-16 ring-4 ring-blue-100 cursor-pointer hover:ring-blue-400 transition-all" onClick={() => navigate('/member/profile-view')}>
