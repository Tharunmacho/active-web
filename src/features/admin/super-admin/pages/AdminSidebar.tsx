...
export default function AdminSidebar({ className = '', onClose, isOpen = false, refreshTrigger = 0 }: Props) {
  ...
  const nav = [
    { to: '/super-admin/dashboard', label: 'Dashboard', icon: <FaHome /> },
    { to: '/super-admin/approvals', label: 'Approvals', icon: <FaCheckCircle /> },
    { to: '/super-admin/members', label: 'Members', icon: <FaUsers /> },
